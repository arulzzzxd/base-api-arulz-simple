...
```
## 📄 Cara Menambahkan Link Bio (linkbio.json)
Tambahkan data pada file ./database/linkbio.json menggunakan format array JSON berikut:
```json
[
  {
    "name": "Facebook",
    "url": "[https://web.facebook.com/shikakuiyayn](https://web.facebook.com/shikakuiyayn)"
  },
  {
    "name": "Telegram",
    "url": "[https://t.me/username](https://t.me/username)"
  }
]
